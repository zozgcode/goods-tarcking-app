  ...
  return (
    <div className="bg-[#4D148C] flex-col md:flex-row p-10 flex justify-between items-center mt-[50px]">
      <div className="flex flex-col items-center md:items-start md:flex-row gap-10">
        <div>
          <img src="https://i.imgur.com/z6pm1gp.png" alt="" />
        </div>
      ...
      <div className="mt-10 md:mt-0">
        <Link to="" className="bg-[#ff6200] block text-center text-[14px] p-4 pl-6 pr-6 uppercase text-white font-semibold">OPEN AN ACCOUNT</Link>
      </div>
    </div>
  );
}
